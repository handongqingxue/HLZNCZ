...
<div class="center_con_div" id="center_con_div">
	<div class="page_location_div">质检报告-详情</div>
	...
	<div id="detail_div">
		<table>
		  <tr style="border-bottom: #CAD9EA solid 1px;">
			...
			<td style="width:30%;">
				<span>${requestScope.gldd.ddh }</span>
			</td>
			<td align="right" style="width:15%;">
				执行状态
			</td>
			<td style="width:30%;">
				<span>${requestScope.gldd.ddztmc }</span>
			</td>
		  </tr>
		  <tr style="border-bottom: #CAD9EA solid 1px;">
			<td align="right" style="width:15%;">
			...
			<td style="width:30%;">
				<span>
				<c:if test="${requestScope.zjbg.jl eq 1 }">合格</c:if>
				<c:if test="${requestScope.zjbg.jl eq 2 }">不合格</c:if>
				</span>
			</td>
			<td align="right" style="width:15%;">
