...
function initAddLB(){
	$("#add_but").linkbutton({
		iconCls:"icon-add",
		onClick:function(){
			location.href=path+"main/gbgl/gbgl/rcgb/new?fnid="+'${param.fnid}'+"&snid="+'${param.snid}';
		}
	});
}
	...
	tab1=$("#tab1").datagrid({
		...
		columns:[[
            ...
            {field:"id",title:"操作",width:150,formatter:function(value,row){
            	...
            	+"&nbsp;|&nbsp;<a href=\"${pageContext.request.contextPath}/main/gbgl/gbgl/rcgb/edit?fnid="+'${param.fnid}'+"&snid="+'${param.snid}'+"&id="+value+"\">修改</a>";
            	return str;
            }}
	    ]],
