...
$(function(){
	...
	$("#add_but").linkbutton({
		iconCls:"icon-add",
		onClick:function(){
			location.href=jcxxPath+"dwgl/fhdw/new?fnid="+'${param.fnid}'+"&snid="+'${param.snid}';
		}
	});
	...
	tab1=$("#tab1").datagrid({
		...
		columns:[[
            ...
            {field:"id",title:"操作",width:150,formatter:function(value,row){
            	var str="<a href=\""+jcxxPath+"dwgl/fhdw/detail?fnid="+'${param.fnid}'+"&snid="+'${param.snid}'+"&id="+value+"\">详情</a>"
            	+"&nbsp;|&nbsp;<a href=\""+jcxxPath+"dwgl/fhdw/edit?fnid="+'${param.fnid}'+"&snid="+'${param.snid}'+"&id="+value+"\">修改</a>";
            	return str;
            }}
	    ]],
...
function deleteByIds() {
	...
	$.messager.confirm("提示","确定要删除吗？",function(r){
		if(r){
			...
			$.post(jcxxPath + "deleteFaHuoDanWei",
				{ids:ids},
				function(result){
					if(result.status==1){
						alert(result.msg);
