...
function initLXLXCBB(){
	ndlxlxCBB=$("#edit_div #lxlx_cbb").combobox({
		...
		onSelect:function(){
			$("#edit_div #lxlx").val($(this).combobox("getValue"));
		}
	});
}
...
function initBJSJDB(){
	...
	bjsjDB.datebox("setValue",'${requestScope.dd.bjsj }');
}
	...
	$.post(path+"main/queryDingDanZhuangTaiCBBList",
		function(result){
			...
			ssddDDZTCBB=$("#edit_div #ddzt_cbb").combobox({
				...
				onSelect:function(){
					$("#edit_div #ddztId").val($(this).combobox("getValue"));
				}
			});
		}
	,"json");
...
function initCYCLTab(){
	...
	if('${requestScope.cycl}'==""){
		...
		rows=[{gx:"1",cph:cph,zcrq:zcrq,id:id}];
	}
	...
	<form id="form1" name="form1" method="post" enctype="multipart/form-data">
		<table>
		  <tr style="border-bottom: #CAD9EA solid 1px;">
			...
			<td style="width:30%;">
				<input type="text" id="cph" name="cph" value="${requestScope.cycl.cph }" placeholder="无需输入" disabled="disabled" style="width: 150px;height:30px;"/>
			</td>
			<td align="right" style="width:15%;">
				订单号
			</td>
			<td style="width:30%;">
				<input type="text" id="ddh" name="ddh" value="${requestScope.dd.ddh }" placeholder="无需输入" disabled="disabled" style="width: 150px;height:30px;"/>
			</td>
		  </tr>
		  <tr style="border-bottom: #CAD9EA solid 1px;">
			<td align="right">
