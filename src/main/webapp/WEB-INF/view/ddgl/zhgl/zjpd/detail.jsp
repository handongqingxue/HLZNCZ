...
<div class="detail_yss_bg_div" id="detail_yss_bg_div">
	<div class="detail_yss_div" id="detail_yss_div">
		...
		<div class="detail_yss_dialog_div" id="detail_yss_dialog_div">
			<div class="title_div">
				<span class="title_span">直接排队-运输商-查看</span>
			</div>
...
<div class="detail_wlxx_bg_div" id="detail_wlxx_bg_div">
	<div class="detail_wlxx_div" id="detail_wlxx_div">
		...
		<div class="detail_wlxx_dialog_div" id="detail_wlxx_dialog_div">
			<div class="title_div">
				<span class="title_span">直接排队-物料信息-查看</span>
			</div>
...
<div class="detail_fhdw_bg_div" id="detail_fhdw_bg_div">
	<div class="detail_fhdw_div" id="detail_fhdw_div">
		...
		<div class="detail_fhdw_dialog_div" id="detail_fhdw_dialog_div">
			<div class="title_div">
				<span class="title_span">直接排队-发货单位-查看</span>
			</div>
...
<div class="detail_shdw_bg_div" id="detail_shdw_bg_div">
	<div class="detail_shdw_div" id="detail_shdw_div">
		...
		<div class="detail_shdw_dialog_div" id="detail_shdw_dialog_div">
			<div class="title_div">
				<span class="title_span">直接排队-收货单位-查看</span>
			</div>
...
<div class="detail_cycl_bg_div" id="detail_cycl_bg_div">
	<div class="detail_cycl_div" id="detail_cycl_div">
		...
		<div class="detail_cycl_dialog_div" id="detail_cycl_dialog_div">
			<div class="title_div">
				<span class="title_span">直接排队-承运车辆-查看</span>
			</div>
...
<div class="detail_cysj_bg_div" id="detail_cysj_bg_div">
	<div class="detail_cysj_div" id="detail_cysj_div">
		...
		<div class="detail_cysj_dialog_div" id="detail_cysj_dialog_div">
			<div class="title_div">
				<span class="title_span">直接排队-承运司机-查看</span>
			</div>
...
<div class="center_con_div" id="center_con_div">
	<div class="page_location_div">直接排队-详情</div>
	<div id="detail_div">
		<input type="hidden" id="id" name="id" value="${requestScope.zjpd.wybm }"/>
		<table>
		  <tr style="border-bottom: #CAD9EA solid 1px;">
			<td align="right" style="width:15%;">
				订单号
			...
			<td style="width:30%;">
				<span>${requestScope.zjpd.ddh }</span>
			</td>
			<td align="right" style="width:15%;">
				预装卸重量
			</td>
			<td style="width:30%;">
				<span>${requestScope.zjpd.yzxzl }</span>
			</td>
		  </tr>
		  <tr style="border-bottom: #CAD9EA solid 1px;">
			<td align="right">
			...
			<td>
				<span>
				<c:if test="${requestScope.zjpd.lxlx eq 1 }">
					送运
				</c:if>
				<c:if test="${requestScope.zjpd.lxlx eq 2 }">
					取运
				</c:if>
				</span>
			</td>
			...
			<td>
				<span>${requestScope.zjpd.bjsj }</span>
			</td>
		  </tr>
		  <tr style="border-bottom: #CAD9EA solid 1px;">
			<td align="right">
			...
			<td>
				<span>${requestScope.zjpd.sjzl }</span>
			</td>
		  </tr>
		  <tr style="border-bottom: #CAD9EA solid 1px;">
			<td align="right">
			...
			<td>
				<span>${requestScope.zjpd.zlceb }</span>
			</td>
			<td align="right">
				订单状态
			</td>
			<td>
				<span>${requestScope.zjpd.ddztmc }</span>
			</td>
		  </tr>
		  <tr style="border-bottom: #CAD9EA solid 1px;">
			<td align="right">
			...
			<td>
				<span>${requestScope.zjpd.jhysrq }</span>
			</td>
			<td align="right">
			</td>
			<td>
