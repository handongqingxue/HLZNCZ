...
.detail_ycxx_div .xz_div{
	width: 100%;
	height: 50px;
	line-height: 50px;
	border-bottom: #eee solid 1px;
}
.detail_ycxx_div .xz_span{
	margin-left: 30px;
}
.detail_ycxx_div .close_span{
	float: right;margin-right: 30px;cursor: pointer;
}
.detail_ycxx_dialog_div{
	width: 1000px;
	height: 450px;
	overflow-y: scroll;
	position: absolute;
}
.detail_ycxx_div .title_div{
	width: 100%;height: 50px;line-height: 50px;
}
.detail_ycxx_div .title_span{
	margin-left: 30px;
}
...
var ycxxdNum=1;
var dycxxjbsxzdNum=2;

var yssdNum=3;
var dyssjbsxzdNum=4;

var wlxxdNum=5;
var dwlxxjbsxzdNum=6;

var fhdwdNum=7;
var dfhdwjbsxzdNum=8;

var shdwdNum=9;
var dshdwjbsxzdNum=10;

var cycldNum=11;
var dcycljbsxzdNum=12;

var cysjdNum=13;
var dcysjjbsxzdNum=14;

$(function(){
	initDetailDialog();

	initYCXXDialog();//1.异常信息窗口
	initDetailYCXXJBSXZDialog();//2.查看异常信息窗口

	initYSSDialog();//3.运输商窗口
	initDetailYSSJBSXZDialog();//4.运输商详情窗口
	
	initWLXXDialog();//5.物料信息窗口
	initDetailWLXXJBSXZDialog();//6.物料信息详情窗口

	initFHDWDialog();//7.发货单位窗口
	initDetailFHDWJBSXZDialog();//8.发货单位详情窗口

	initSHDWDialog();//9.收货单位窗口
	initDetailSHDWJBSXZDialog();//10.收货单位详情窗口

	initCYCLDialog();//11.承运车辆窗口
	initDetailCYCLJBSXZDialog();//12.承运车辆详情窗口

	initCYSJDialog();//13.承运司机窗口
	initDetailCYSJJBSXZDialog();//14.承运司机详情窗口
...
function initDialogPosition(){
	...
	//查看异常信息
	var dycxxjbsxdpw=$("body").find(".panel.window").eq(dycxxjbsxzdNum);
	var dycxxjbsxdws=$("body").find(".window-shadow").eq(dycxxjbsxzdNum);
	...
	var dycxxdDiv=$("#detail_ycxx_dialog_div");
	dycxxdDiv.append(dycxxjbsxdpw);
	dycxxdDiv.append(dycxxjbsxdws);
	...
	ycxxTab=$("#ycxx_tab").datagrid({
		...
		columns:[[
			...
			{field:"id",title:"操作",width:200,align:"center",formatter:function(value,row){
            	var str="<a onclick=\"showYCXXDetail()\">查看</a>";
            	return str;
            }}
	    ]],
...
function initDetailYCXXJBSXZDialog(){
	detailYCXXDialog=$("#detail_ycxx_jbsxz_dialog_div").dialog({
		title:"基本属性组",
		width:setFitWidthInParent("#detail_ycxx_div","detail_ycxx_jbsxz_dialog_div"),
		height:231,
		top:10,
		left:20,
		buttons:[
           {text:"取消",id:"cancel_but",iconCls:"icon-cancel",handler:function(){
        	   openDetailYCXXDialog(0);
           }},
	...
	$("#detail_ycxx_jbsxz_dialog_div table").css("width",(setFitWidthInParent("#detail_ycxx_div","detail_ycxx_jbsxz_dialog_div"))+"px");
	$("#detail_ycxx_jbsxz_dialog_div table").css("magin","-100px");
	$("#detail_ycxx_jbsxz_dialog_div table td").css("padding-left","50px");
	$("#detail_ycxx_jbsxz_dialog_div table td").css("padding-right","20px");
	$("#detail_ycxx_jbsxz_dialog_div table td").css("font-size","15px");
	$("#detail_ycxx_jbsxz_dialog_div table tr").css("height","45px");

	$(".panel.window").eq(dycxxjbsxzdNum).css("margin-top","40px");
	$(".panel.window .panel-title").eq(dycxxjbsxzdNum).css("color","#000");
	$(".panel.window .panel-title").eq(dycxxjbsxzdNum).css("font-size","15px");
	$(".panel.window .panel-title").eq(dycxxjbsxzdNum).css("padding-left","10px");
	
	$(".panel-header, .panel-body").css("border-color","#ddd");
	
	//以下的是表格下面的面板
	$(".window-shadow").eq(dycxxjbsxzdNum).css("margin-top","40px");
	$(".window,.window .window-body").css("border-color","#ddd");

	$("#detail_ycxx_jbsxz_dialog_div #cancel_but").css("left","30%");
	$("#detail_ycxx_jbsxz_dialog_div #cancel_but").css("position","absolute");

	$("#detail_ycxx_jbsxz_dialog_div #ok_but").css("left","45%");
	$("#detail_ycxx_jbsxz_dialog_div #ok_but").css("position","absolute");
...
function openDetailYCXXDialog(flag){
	if(flag==1){
		$("#detail_ycxx_bg_div").css("display","block");
		$("#detail_ycxx_bg_div").css("z-index",showZIndex);
	}
	else{
		$("#detail_ycxx_bg_div").css("display","none");
		$("#detail_ycxx_bg_div").css("z-index","9016");
	}
	openDetailYCXXJBSXZDialog(flag);
}

function openDetailYCXXJBSXZDialog(flag){
	if(flag==1){
		detailYCXXDialog.dialog("open");
	}
	else{
		detailYCXXDialog.dialog("close");
	}
}
...
function showYCXXDetail(){
	...
	$("#detail_ycxx_div #yclx").text(yclxStr);
	var clztStr;
	switch (row.clzt) {
		case 1:
			clztStr="待处理";
	...
	$("#detail_ycxx_div #clzt").text(clztStr);
	$("#detail_ycxx_div #ms").text(row.ms);
	$("#detail_ycxx_div #clsm").text(row.clsm);
	openDetailYCXXDialog(1);
}
...
function showCYCLDetail(){
	...
	$("#detail_cycl_div #cllx").text(cllxStr);
	...
	$("#detail_cycl_div #pfjd").text(pfjdStr);
	$("#detail_cycl_div #zcrq").text(row.zcrq);
	$("#detail_cycl_div #sfzy").text(row.sfzy?"是":"否");
	...
	$("#detail_cycl_div #clyslx").text(clyslxStr);
...
function setFitWidthInParent(parent,self){
	...
	case "fhdw_tab":
		space=355;
		break;
	case "detail_ycxx_jbsxz_dialog_div":
...
<!-- 查看异常信息 start -->
<div class="detail_ycxx_bg_div" id="detail_ycxx_bg_div">
	<div class="detail_ycxx_div" id="detail_ycxx_div">
		<div class="xz_div">
			<span class="xz_span">修改</span>
			<span class="close_span" onclick="openEditYCXXDialog(0)">X</span>
		</div>
		<div class="detail_ycxx_dialog_div" id="detail_ycxx_dialog_div">
			<div class="title_div">
				<span class="title_span">异常处理-异常信息-新增</span>
			</div>
			<div id="detail_ycxx_jbsxz_dialog_div">
				<table>
...
<div class="detail_cycl_bg_div" id="detail_cycl_bg_div">
	<div class="detail_cycl_div" id="detail_cycl_div">
		...
		<div class="detail_cycl_dialog_div" id="detail_cycl_dialog_div">
			<div class="title_div">
				<span class="title_span">综合管理-承运车辆-查看</span>
			</div>
...
<div class="detail_cysj_bg_div" id="detail_cysj_bg_div">
	<div class="detail_cysj_div" id="detail_cysj_div">
		...
		<div class="detail_cysj_dialog_div" id="detail_cysj_dialog_div">
			<div class="title_div">
				<span class="title_span">综合管理-承运司机-查看</span>
			</div>
...
<div class="center_con_div" id="center_con_div">
	<div class="page_location_div">异常处理-详情</div>
	<div id="detail_div">
